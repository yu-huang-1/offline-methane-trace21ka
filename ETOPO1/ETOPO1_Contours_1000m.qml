...
<qgis readOnly="1" version="3.16.1-Hannover" simplifyMaxScale="1e+06" simplifyDrawingHints="1" labelsEnabled="1" styleCategories="AllStyleCategories" minScale="100000000" simplifyDrawingTol="1" simplifyAlgorithm="0" simplifyLocal="1" hasScaleBasedVisibilityFlag="0" maxScale="0">
  <flags>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontSizeUnit="Point" allowHtml="0" fontUnderline="0" blendMode="0" fontWordSpacing="0" fontLetterSpacing="0" textColor="0,0,0,255" fontWeight="50" fontItalic="0" fieldName="Contour_m" fontStrikeout="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" useSubstitutions="0" fontFamily="Calibri" previewBkgrdColor="255,255,255,255" capitalization="0" textOpacity="1" namedStyle="Normal" fontSize="9" multilineHeight="1" isExpression="0" fontKerning="1" textOrientation="horizontal">
        <text-buffer bufferSize="1" bufferSizeUnits="MM" bufferNoFill="0" bufferJoinStyle="128" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferOpacity="1" bufferBlendMode="0" bufferDraw="1" bufferColor="230,230,230,255"/>
        <text-mask maskEnabled="0" maskJoinStyle="128" maskType="0" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskOpacity="1" maskedSymbolLayers="" maskSizeUnits="MM" maskSize="1.5"/>
      ...
      <placement distUnits="MM" offsetType="0" rotationAngle="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" placement="2" layerType="UnknownGeometry" repeatDistance="0" lineAnchorPercent="0.5" quadOffset="4" dist="0" distMapUnitScale="3x:0,0,0,0,0,0" offsetUnits="MapUnit" placementFlags="9" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" geometryGenerator="" centroidWhole="0" xOffset="0" preserveRotation="1" geometryGeneratorType="PointGeometry" overrunDistanceUnit="MM" yOffset="0" maxCurvedCharAngleIn="25" overrunDistance="0" lineAnchorType="0" fitInPolygonOnly="0" geometryGeneratorEnabled="0" maxCurvedCharAngleOut="-25" repeatDistanceUnits="MM" polygonPlacementFlags="2" centroidInside="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" priority="5"/>
      <rendering obstacleFactor="1" scaleMax="20000001" maxNumLabels="2000" obstacleType="0" labelPerPart="0" obstacle="1" mergeLines="0" fontLimitPixelSize="0" upsidedownLabels="0" minFeatureSize="99.98999999999999" drawLabels="1" zIndex="0" scaleVisibility="1" fontMaxPixelSize="10000" displayAll="0" scaleMin="1" limitNumLabels="0" fontMinPixelSize="3"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" type="QString" name="name"/>
          <Option name="properties"/>
  ...
  <DiagramLayerSettings obstacle="0" priority="0" dist="0" placement="2" zIndex="0" showAll="1" linePlacementFlags="10">
    <properties>
      <Option type="Map">
        <Option value="" type="QString" name="name"/>
        <Option name="properties"/>
  ...
  <referencedLayers/>
  <fieldConfiguration>
    <field configurationFlags="None" name="FID_ETOPO1">
    ...
    <field configurationFlags="None" name="Contour_m">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option value="0" type="QString" name="IsMultiline"/>
    ...
    <field configurationFlags="None" name="FID_1000ne">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option value="0" type="QString" name="IsMultiline"/>
  ...
  <aliases>
    <alias index="0" name="" field="FID_ETOPO1"/>
    <alias index="1" name="" field="Contour_m"/>
    <alias index="2" name="" field="FID_1000ne"/>
    <alias index="3" name="" field="Id"/>
  </aliases>
  <defaults>
    <default expression="" field="FID_ETOPO1" applyOnUpdate="0"/>
    <default expression="" field="Contour_m" applyOnUpdate="0"/>
    <default expression="" field="FID_1000ne" applyOnUpdate="0"/>
    <default expression="" field="Id" applyOnUpdate="0"/>
  </defaults>
  <constraints>
    <constraint notnull_strength="0" exp_strength="0" unique_strength="0" constraints="0" field="FID_ETOPO1"/>
    <constraint notnull_strength="0" exp_strength="0" unique_strength="0" constraints="0" field="Contour_m"/>
    <constraint notnull_strength="0" exp_strength="0" unique_strength="0" constraints="0" field="FID_1000ne"/>
    <constraint notnull_strength="0" exp_strength="0" unique_strength="0" constraints="0" field="Id"/>
  </constraints>
  <constraintExpressions>
    <constraint field="FID_ETOPO1" exp="" desc=""/>
    <constraint field="Contour_m" exp="" desc=""/>
    <constraint field="FID_1000ne" exp="" desc=""/>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column hidden="0" type="field" width="-1" name="Contour_m"/>
      <column hidden="0" type="field" width="-1" name="FID_ETOPO1"/>
      <column hidden="0" type="field" width="-1" name="Id"/>
      <column hidden="0" type="field" width="-1" name="FID_1000ne"/>
    </columns>
  ...
  <storedexpressions/>
  <editform tolerant="1">D:/Quantarctica3</editform>
  <editforminit/>
  <editforminitcodesource>0</editforminitcodesource>
  <editforminitfilepath>D:/Quantarctica3</editforminitfilepath>
...
def my_form_open(dialog, layer, feature):
  ...
  <widgets/>
  <previewExpression>COALESCE( "CONTOUR", '&lt;NULL>' )</previewExpression>
  <mapTip>CONTOUR</mapTip>
